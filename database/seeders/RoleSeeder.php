...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'view files'])->syncRoles(['agent','admin','online warrior','manager','finance admin','team leader']);
        Permission::create(['name' => 'add files'])->syncRoles(['admin']);
