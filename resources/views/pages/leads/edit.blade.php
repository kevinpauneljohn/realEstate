                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="birthday" value="{{$lead->birthday}}" class="form-control datemask" id="birthday" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy/mm/dd" data-mask="" im-insert="false">
                                    </div>
                                </div>
                            </div>
                            <br />
